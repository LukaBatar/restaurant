...
?>
    <tr>
        ...
        <td><?php echo $r['cena1'] ?></td>
        <td><?php echo $r['kolicina'] ?></td>
        <td><?php echo $r['cena2'] ?></td>
    </tr>
<?php
}
?>
...
<br><br>
<a href="routes.php?page=showtable&idstola=<?php echo $idstola; ?>">Nazad na sto</a><br><br>
<a href="routes.php?page=finishBill&idstola=<?php echo $idstola; ?>">Zavrsi racun</a>
