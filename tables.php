...
foreach($prvi as $pom){
    ...
    echo "Id stola: ".$pom['idstola']."<br>Broj mesta: ".$pom['brojmesta']." Pozicija: ".$pom['pozicija'];
    echo "</div></div>";
}
echo "<br><br>";
...
<input type="hidden" name="page" value="showtable">

<?php

foreach($prvi as $pom){
  if($pom['dostupnost']==0){echo "<button type='submit' name='idstola' value='$pom[idstola]' class='btn btn-success'>Br stola: $pom[idstola]<br>Broj mesta: $pom[brojmesta] Pozicija: $pom[pozicija]</button>";}else{echo "<button  type='submit' name='idstola' value='$pom[idstola]' class='btn btn-danger'>Id stola: $pom[idstola]<br>Broj mesta: $pom[brojmesta] Pozicija: $pom[pozicija]</button>";}
  echo "&nbsp";
}
echo "<br><br>";
foreach($drugi as $pom){
